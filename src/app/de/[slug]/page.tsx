...
export function generateStaticParams() {
  return coursePages.filter((course) => course.slug !== "famed-offline" && course.slug !== "fsp-medizin" && course.slug !== "fsp-zahnmedizin" && course.slug !== "famed").map((course) => ({ slug: course.slug }));
}
