        ...
        <section className="mx-auto max-w-3xl px-5 py-14 lg:px-8 lg:py-20">
          ...
          <div className="mt-16 rounded-[2rem] bg-[#f3eff7] p-7 sm:p-8">
            ...
            <p className="mt-5 text-xs leading-5 text-black/40">
              Anforderungen können sich je nach Bundesland, zuständiger Stelle
              und persönlichem Anerkennungsverfahren unterscheiden. Prüfen Sie
              deshalb immer die aktuellen Angaben Ihrer zuständigen Behörde.
            </p>
          </div>
          ...
          <div className="mt-12 rounded-[2.3rem] bg-[#31175B] p-8 text-white sm:p-10">
            ...
            <h2 className="mt-4 text-3xl font-semibold">
              Medizinische Sprache nicht nur lernen. Anwenden.
            </h2>

            <p className="mt-4 max-w-xl leading-7 text-white/60">
              Entdecken Sie unsere Vorbereitung für FSP, FaMed, Zahnmedizin
              und realistische Prüfungssimulationen.
            </p>
