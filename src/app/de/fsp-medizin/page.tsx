...
export const metadata: Metadata = {
  ...
  description:
    "8 Wochen intensive FSP-Medizin-Vorbereitung mit 68 Unterrichtsstunden plus Blended Learning, 6 Prüfungssimulationen, kleinen Gruppen und digitalen Lernmaterialien.",
};
...
const outcomes = [
  {
    number: "01",
    title: "Anamnese sicher führen",
    text: "Medizinische Informationen strukturiert erfragen und das Patientengespräch sprachlich sicherer führen.",
  },
  {
    number: "02",
    title: "Medizinische Fachsprache einsetzen",
    text: "Prüfungsrelevante medizinische Sprache nicht nur verstehen, sondern aktiv in der Kommunikation anwenden.",
  },
  {
    number: "03",
    title: "Dokumentation trainieren",
    text: "Informationen aus dem Patientengespräch strukturiert erfassen und für die schriftliche Dokumentation aufbereiten.",
  },
  {
    number: "04",
    title: "Patienten vorstellen",
...
const steps = [
  ...
  },
  {
    ...
    text: "In sechs Prüfungssimulationen wenden Sie das Gelernte in realistischen Situationen an.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Der Kurs umfasst 68 Unterrichtsstunden plus Blended Learning.",
  },
  {
    q: "Sind Prüfungssimulationen enthalten?",
    a: "Ja. Im Kurs sind 6 Prüfungssimulationen vorgesehen.",
  },
  {
...
export default function FspMedizinPage() {
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          <div>
            ...
            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Medizinisch kommunizieren. Unter Prüfungsbedingungen sicher anwenden.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Intensive Vorbereitung auf medizinische Fachsprache,
              Arzt-Patienten-Kommunikation, Dokumentation, Patientenvorstellung
      ...
      <FacultyTrustSection lang="de" variant="fsp" />
          ...
          <div className="grid gap-12 lg:grid-cols-[.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-white/60">
                ...
                und Prüfungssimulationen in einem zusammenhängenden
                Vorbereitungsweg.
              </p>
            </div>
