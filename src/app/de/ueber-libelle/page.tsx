...
export const metadata: Metadata = {
  title: "Über Libelle Academy",
  description:
    "Libelle Academy verbindet Live-Unterricht in kleinen Gruppen mit digitalen Lernmaterialien, allgemeinen Deutschkursen und medizinischer Prüfungsvorbereitung.",
};
...
const principles = [
  ...
  {
    number: "02",
    title: "Digital vertiefen",
    text: "Digitale Lernmaterialien und der Pelexa-Lernbereich ergänzen den Unterricht zwischen den Kursterminen.",
  },
  {
    number: "03",
    title: "In kleinen Gruppen arbeiten",
    text: "Überschaubare Gruppen ermöglichen mehr aktive Kommunikation und individuellere Begleitung.",
  },
  {
    number: "04",
    title: "Mit einem klaren Ziel lernen",
  ...
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[680px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            ...
            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Live lernen. Digital vertiefen. Gezielt weiterkommen.
            </h1>
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="home-orbit absolute right-10 -top-10 z-20 hidden rounded-2xl bg-[#58ECF1] px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.18)] lg:block">
              ...
              <div className="mt-1 text-sm font-semibold">
                Lernen endet nicht nach dem Unterricht
              </div>
            </div>
            ...
            <div className="home-orbit-delay absolute bottom-[-46px] left-10 z-20 hidden rounded-2xl bg-white px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.16)] lg:block">
              ...
              <div className="mt-1 text-sm font-semibold">
                Vom aktuellen Stand zum nächsten Ziel
              </div>
            </div>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-6 shadow-[0_30px_90px_rgba(49,23,91,.16)]">
              ...
              <div className="mt-3 text-3xl font-semibold">
                Lernen hört nicht nach dem Live-Unterricht auf.
              </div>
      ...
      <EditorialStorySection
        eyebrow="LERNEN MIT EINEM ZIEL"
        title="Unterricht ist wichtig. Entscheidend ist, was danach abrufbar bleibt."
        text="Libelle verbindet Live-Unterricht, digitale Vertiefung und aktive Anwendung, damit Lernen nicht aus einzelnen Terminen besteht, sondern aus einem nachvollziehbaren Weg."
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[.9fr_1.1fr]">
          ...
          <div className="rounded-[2.5rem] bg-[#f3eff7] p-8 sm:p-10">
            ...
            <div className="mt-7 space-y-4">
              {[
                ["01", "Aufzeichnungen", "Live-Inhalte später erneut ansehen."],
                [
                  "02",
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              [
                ...
                "Live-Unterricht und digitale Inhalte ergänzen sich statt voneinander getrennt zu stehen.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
