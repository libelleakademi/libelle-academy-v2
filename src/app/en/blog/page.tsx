...
export const metadata: Metadata = {
  title: "Blog | German, FSP & FaMed | Libelle Academy",
  description:
    "Articles about German, medical German, FSP, FaMed and working in Germany.",
};

export default function BlogPage() {
  const featured = blogPostsEN[0];
  const rest = blogPostsEN.slice(1);
      ...
      <section className="bg-[#D2ECFF]/40">
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="mt-5 max-w-4xl text-5xl font-semibold tracking-[-.045em] sm:text-6xl lg:text-7xl">
            Knowledge that genuinely moves you forward.
          </h1>

          <p className="mt-7 max-w-2xl text-lg leading-8 text-black/55">
            German, medical language, exam preparation and professional life
            in Germany — explained clearly and practically.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em]">
            Language, medicine and life in Germany.
          </h2>
        </div>
