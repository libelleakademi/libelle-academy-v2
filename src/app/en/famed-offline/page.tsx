...
export const metadata: Metadata = {
  title: "FaMed Offline Course | Libelle Academy",
  description:
    "FaMed flexibel vorbereiten: strukturierte Module, Documentation and exercises. FaMed Offline Kurs für 200 € oder inklusive 5 Exam simulations für 575 €.",
};
...
const benefits = [
  ...
  "Digital materials for exam preparation",
];
...
const bundleMessage =
  "Hallo, ich interessiere mich für FaMed Offline + 5 Simulations für 575 €. Quelle: LANDING-FAMED-OFFLINE-BUNDLE";
    ...
    <main className="min-h-screen bg-white text-[#17131c]">
      ...
      <section className="overflow-hidden bg-[#f7f5f9]">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:py-24">
          <div>
            <Link href="/en" className="text-sm font-semibold text-[#31175B]">
              ← Back to Overview
            </Link>
            ...
            <h1 className="mt-6 max-w-3xl text-5xl font-semibold leading-[1.03] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              Prepare for FaMed at your own pace.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/55">
              Ein strukturierter Offline-Kurs mit digitalen Modulen, Documentation and exercises für eine flexible FaMed-Vorbereitung.
            </p>
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Ask about FaMed Offline for €200
              </a>
              <a
                href="#pakete"
            ...
            <div className="rounded-[2rem] bg-[#f3eff7] p-6 sm:p-7">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <div className="mt-2 text-2xl font-semibold">FaMed learning area</div>
                </div>
              ...
              <div className="mt-4 rounded-2xl border border-[#31175B]/10 bg-white/55 px-5 py-4 text-sm text-black/45">
                + weitere Inhalte, Documentation and exercises
              </div>
            </div>
          </div>
      ...
      <EditorialStorySection
        eyebrow="FLEXIBLE VORBEREITEN"
        title="Learn independently — then test what you have learned in practice."
        text="Der FaMed Offline Kurs ermöglicht eine flexible Vorbereitung mit digitalen Inhalten, Documentation and exercises. Wer die Anwendung zusätzlich unter Prüfungsbedingungen trainieren möchte, kann den Lernweg mit Live-Simulations ergänzen."
        image="/images/home-medical-german-learning.jpg"
        alt="Medizinisches Lernen mit digitalen Materialien"
        chip="OFFLINE LERNEN · LIVE APPLY"
        reverse
      />
        ...
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
              Step by step through your FaMed preparation.
            </h2>
            <p className="mt-6 max-w-xl text-lg leading-8 text-black/50">
              Die Module verbinden prüfungsrelevante Themen mit Documentation and exercises, die Sie flexibel bearbeiten können.
            </p>
          </div>
      ...
      <section id="pakete" className="bg-[#31175B] py-24 text-white">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
              Flexible lernen oder mit Live-Simulations kombinieren.
            </h2>
          </div>
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-2">
            <article className="rounded-[2.2rem] border border-white/10 bg-white/8 p-8 sm:p-10">
              ...
              <p className="mt-5 max-w-xl leading-7 text-white/60">
                Der komplette Offline-Kurs mit Flexiblen, Documentation and exercises.
              </p>
            ...
            <article className="relative rounded-[2.2rem] bg-white p-8 text-[#17131c] sm:p-10">
              ...
              <p className="mt-5 max-w-xl leading-7 text-black/55">
                FaMed Offline plus fünf Exam simulations für die anschließende Live-Prüfungspraxis.
              </p>
              <ul className="mt-8 space-y-3 text-sm text-black/65">
                <li>✓ FaMed Offline Kurs</li>
                <li>✓ 5 Live-Simulations</li>
                <li>✓ Train exam situations</li>
              ...
              >
                Ask about the complete package
              </a>
            </article>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
              Build your knowledge. Then apply it under exam conditions.
            </h2>
          </div>

          <div className="space-y-4">
            {[
              ["01", "Flexible vorbereiten", "Bearbeiten Sie die Offline-Inhalte in Ihrem eigenen Tempo."],
              ["02", "Practice strategically", "Nutzen Sie Documentation and exercises zur Vertiefung."],
              ["03", "Test live", "Trainieren Sie anschließend in realistischen Exam simulations."],
      ...
      <section className="px-5 pb-20 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-[#17131c] p-9 text-white sm:p-14">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
              Which option fits your preparation better?
            </h2>
            <p className="mt-5 text-lg leading-8 text-white/55">
              Schreiben Sie uns über WhatsApp. Wir helfen Ihnen bei der Auswahl zwischen dem Offline-Kurs und dem Paket mit Simulations.
            </p>
            <a
              href={whatsappLink(
