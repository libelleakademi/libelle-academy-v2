...
import FamedConversion from "@/components/en/FamedConversion";
import { whatsappLink } from "@/lib/whatsapp";

export const metadata: Metadata = {
  title: "FaMed Intensivkurs | Libelle Academy",
  description:
    "6 weeks FaMed-Vorbereitung mit 54 lesson units, Blended learning via Pelexa, kleinen Gruppen und 6 exam simulations.",
};
...
const phases = [
  ...
  },
  {
    ...
    text: "In der Schlussphase liegt der Schwerpunkt auf intensiven FaMed-exam simulations.",
  },
  {
    number: "03",
...
const faqs = [
  ["Wie lange dauert der FaMed Intensivkurs?", "Der Kurs dauert 6 weeks."],
  [
    "Wie umfangreich ist der Unterricht?",
    "Der Kurs umfasst 54 lesson units. Eine Unterrichtsstunde entspricht 40 Minuten.",
  ],
  [
  ...
  [
    "Sind exam simulations enthalten?",
    "Ja. Insgesamt sind 6 FaMed-exam simulations vorgesehen.",
  ],
  [
...
export default function FamedPage() {
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          ...
          <div>
            ...
            <div className="mt-10 text-xs font-bold tracking-[.18em] text-[#17666a]">
              FAMED · INTENSIVE COURSE
            </div>

            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Do not just know FaMed. Apply it under exam conditions.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Structured preparation for medical communication, history-taking, patient explanation, documentation, patient presentation and the FaMed exam format.
            </p>
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="home-orbit absolute right-12 -top-12 z-20 hidden rounded-2xl bg-[#58ECF1] px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.18)] lg:block">
              ...
              <div className="mt-1 text-sm font-semibold">
                From learning to the exam conversation
              </div>
            </div>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-5 shadow-[0_30px_90px_rgba(49,23,91,.18)] sm:p-7">
              ...
              <div className="mt-4 space-y-3">
                {[
                  "54 lesson units",
                  "Small groups mit 6–8 Teilnehmenden",
                  "Blended learning via Pelexa",
                ].map((item) => (
                  <div
                    key={item}
              ...
              <div className="mt-5 rounded-[1.6rem] bg-[#31175B] p-5 text-white">
                ...
                <p className="mt-2 leading-7 text-white/75">
                  For physicians preparing for FaMed with at least a B2 language certificate.
                </p>
              </div>
            </div>
          </div>
      ...
      <FacultyTrustSection lang="en" variant="famed" />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/60">
              ...
              exam simulations greifen ineinander.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              [
                "6–8 Personen",
                "Small groups schaffen mehr Raum für aktives sprachliches Training.",
              ],
              [
                "6 Simulationen",
