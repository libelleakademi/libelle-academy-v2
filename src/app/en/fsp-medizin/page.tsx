...
import FspConversion from "@/components/en/FspConversion";
import { whatsappLink } from "@/lib/whatsapp";

export const metadata: Metadata = {
  title: "FSP Medizin Intensivkurs | Libelle Academy",
  description:
    "8 weeks intensive FSP-Medizin-Vorbereitung mit 68 lesson units plus Blended Learning, 6 exam simulations, kleinen Gruppen und digitalen Lernmaterialien.",
};
...
const outcomes = [
  {
    number: "01",
    title: "Conduct medical history-taking confidently",
    text: "Collect medical information systematically and communicate with patients more confidently.",
  },
  {
    number: "02",
    title: "Use medical professional language",
    text: "Do not just understand exam-relevant medical language — use it actively in communication.",
  },
  {
    number: "03",
...
const steps = [
  ...
  },
  {
    ...
    text: "In sechs exam simulations wenden Sie das Gelernte in realistischen Situationen an.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "Der Kurs umfasst 68 lesson units plus Blended Learning.",
  },
  {
    q: "Sind exam simulations enthalten?",
    a: "Ja. Im Kurs sind 6 exam simulations vorgesehen.",
  },
  {
...
export default function FspMedizinPage() {
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          <div>
            ...
            <div className="mt-10 text-xs font-bold tracking-[.18em] text-[#17666a]">
              FSP MEDIZIN · INTENSIVE COURSE
            </div>

            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Communicate medically. Apply it confidently under exam conditions.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Intensive preparation for medical professional language, doctor-patient communication, documentation, patient presentation and realistic exam situations.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              {[
                "8 weeks",
                "68 lesson units + Blended Learning",
                "6 exam simulations",
              ].map((item) => (
                <span
                  key={item}
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="home-orbit absolute right-10 -top-7 z-20 hidden rounded-2xl bg-[#58ECF1] px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.18)] lg:block">
              ...
              <div className="mt-1 text-sm font-semibold text-[#17131c]">
                Experience the exam before it counts
              </div>
            </div>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-5 shadow-[0_30px_90px_rgba(49,23,91,.18)] sm:p-7">
              ...
              <div className="mt-4 space-y-3">
                {[
                  "68 lesson units + Blended Learning",
                  "Small groups",
                  "Digital learning materials via Pelexa",
                ].map((item) => (
                  <div
                    key={item}
      ...
      <FacultyTrustSection lang="en" variant="fsp" />
          ...
          <div className="grid gap-12 lg:grid-cols-[.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg leading-8 text-white/60">
                ...
                und exam simulations in einem zusammenhängenden
                Vorbereitungsweg.
              </p>
            </div>
