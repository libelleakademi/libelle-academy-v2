...
import ZahnConversion from "@/components/en/ZahnConversion";
import { whatsappLink } from "@/lib/whatsapp";

export const metadata: Metadata = {
  title: "FSP & FaMed Dentistry Intensive Course | Libelle Academy",
  description:
    "8 weeks intensive Vorbereitung auf zahnmedizinische Fachsprache, Patient conversation, Dokumentation, Patient presentation und prüfungsorientiertes Training.",
};

const mainMessage =
  "Hallo, ich interessiere mich für den FSP & FaMed Dentistry Intensivkurs für 950 €. Bitte senden Sie mir Informationen zur nächsten Gruppe und zu freien Plätzen. Quelle: FSP-FAMED-ZAHNMEDIZIN-LANDING";

const consultationMessage =
  "Hallo, ich interessiere mich für die Dentistry-Vorbereitung und möchte wissen, ob der Intensivkurs zu meinem aktuellen Stand passt. Quelle: ZAHNMEDIZIN-BERATUNG";

const outcomes = [
  {
    number: "01",
    title: "Dentistryische Fachsprache sicherer einsetzen",
    text: "Prüfungsrelevante zahnmedizinische Begriffe und Formulierungen aktiv in Gesprächen anwenden.",
  },
  {
    number: "02",
    title: "Conduct patient conversations systematically",
    text: "Anamnese und Patient conversation sprachlich klar, nachvollziehbar und prüfungsorientiert trainieren.",
  },
  {
    number: "03",
    title: "Practice documentation strategically",
    text: "Informationen aus dem Gespräch geordnet erfassen und für die schriftliche Dokumentation aufbereiten.",
  },
  {
    number: "04",
    title: "Structure patient presentations effectively",
    text: "Fälle strukturiert präsentieren und medizinische Zusammenhänge sprachlich sicherer vermitteln.",
  },
];

const program = [
  "Dentistryische Fachsprache",
...
const steps = [
  {
    ...
    text: "Dentistryische Fachsprache und typische Prüfungssituationen werden systematisch aufgebaut.",
  },
  {
    number: "02",
    eyebrow: "APPLY",
    title: "Kommunikation praktisch trainieren",
    text: "Patient conversation, Anamnese, Dokumentation und Vorstellung werden miteinander verbunden.",
  },
  {
    number: "03",
    eyebrow: "SIMULATE",
    title: "Unter Prüfungsbedingungen testen",
    text: "Simulations und Feedback helfen Ihnen, Sprache, Struktur und Sicherheit gezielt weiterzuentwickeln.",
  },
];

const faqs = [
  {
    q: "Wie lange dauert der Dentistry Intensivkurs?",
    a: "Der aktuell hinterlegte Kursumfang beträgt 8 weeks.",
  },
  {
  ...
  {
    q: "Sind Simulations enthalten?",
    a: "Ja. Simulations und individuelles Feedback sind Bestandteil der Vorbereitung.",
  },
  {
...
export default function FspDentistryPage() {
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          <div>
            ...
            <div className="mt-10 text-xs font-bold tracking-[.18em] text-[#17666a]">
              FSP & FAMED ZAHNMEDIZIN · INTENSIVE COURSE
            </div>

            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Dentistryisch kommunizieren. Prüfungsorientiert trainieren.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Intensive preparation for dental professional language, patient communication, history-taking, documentation, patient presentation and realistic exam situations.
            </p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Ask about availability & next group
              </a>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-5 shadow-[0_30px_90px_rgba(49,23,91,.18)] sm:p-7">
              ...
              <div className="mt-5 rounded-[1.6rem] bg-[#31175B] p-5 text-white">
                ...
                <p className="mt-2 leading-7 text-white/75">
                  Dentistryische Kommunikation strukturiert trainieren und
      ...
      <EditorialStorySection
        eyebrow="DENTAL COMMUNICATION"
        title="Professional language becomes valuable when the patient understands it."
        ...
        secondaryAlt="Dentistryisches Patient conversation"
      ...
      <section id="kurs" className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-4xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
            Nicht nur Fachbegriffe kennen. Dentistryisch kommunizieren.
          </h2>
      ...
      <section className="bg-[#f7f5f9]">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[.78fr_1.22fr] lg:px-8">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
              Die zentralen Bereiche Ihrer Dentistry-Vorbereitung.
            </h2>

            <p className="mt-6 max-w-xl text-lg leading-8 text-black/55">
              Vom Patient conversation bis zur Dokumentation und strukturierten
              Patient presentation greifen die einzelnen Bereiche ineinander.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-5 py-24 lg:grid-cols-2 lg:px-8">
          <div className="rounded-[2.2rem] bg-white p-8 sm:p-10">
            ...
            <p className="mt-6 text-lg leading-8 text-black/55">
              ...
              Patient conversatione und prüfungsrelevante Kommunikation
        ...
        <div className="mx-auto grid max-w-7xl gap-8 rounded-[2.6rem] bg-[#17131c] p-8 text-white md:grid-cols-[1fr_auto] md:items-center sm:p-12">
          <div>
            ...
            <h2 className="mt-5 max-w-4xl text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
              Bereiten Sie sich strukturiert auf Ihre Dentistry-Prüfung vor.
            </h2>
