...
import HomeConversion from "@/components/en/HomeConversion";
import { whatsappLink } from "@/lib/whatsapp";

export const metadata: Metadata = {
  title: "Libelle Academy | Deutsch & medizinische Prüfungsvorbereitung",
  description:
    "Deutsch A1–B2, FSP, FaMed, Zahnmedizin und realistische Exam simulations.",
};
    ...
    <main className="bg-white text-[#17131c]">
        ...
        <div className="relative mx-auto grid min-h-[720px] max-w-7xl items-center gap-14 px-5 py-20 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h1 className="mt-7 text-5xl font-semibold leading-[1.01] tracking-[-.05em] sm:text-6xl lg:text-7xl">
              Your German should not stop you from taking the next step.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/55">
              Whether you are starting at A1, aiming for B2 or preparing for a medical exam, you do not simply need more material. You need a clear learning path and real application.
            </p>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-5 shadow-[0_35px_100px_rgba(49,23,91,.20)]">
              <div className="rounded-[2.2rem] bg-[#f3eff7] p-7">
                ...
                <div className="mt-7 space-y-3">
                  {[
                    ["01", "Build your German", "A1 → B2"],
                    ["02", "Specialize in medical German", "FSP · FaMed"],
                    ["03", "Test yourself realistically", "Simulationen"],
                ...
                <div className="mt-5 rounded-[1.5rem] bg-[#D2ECFF]/70 p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-black/55">
                    Your level, goal and exam date are enough for the first orientation step.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="border-y border-black/5">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-6 px-5 py-7 text-center md:grid-cols-4 lg:px-8">
          {[
            ...
            ["Digital", "Pelexa & materials"],
            ["Klein", "Small groups"],
            ["Realistisch", "Exam simulations"],
          ].map(([title, text]) => (
            <div key={title}>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          ...
          <div>
            ...
            <h2 className="mt-5 text-4xl font-semibold leading-[1.05] tracking-[-.045em] sm:text-5xl lg:text-6xl">
              German is not the real goal.
              <span className="block text-[#31175B]">
                The life it makes possible is.
              </span>
            </h2>

            <p className="mt-7 max-w-xl text-lg leading-8 text-black/55">
              Communicate independently in everyday life. Feel more confident professionally. Understand conversations, make decisions and gradually feel at home in Germany.
            </p>

            <div className="mt-9 grid gap-3 sm:grid-cols-3">
              {[
                ["EVERYDAY LIFE", "Communicate independently"],
                ["CAREER", "Communicate with confidence"],
                ["FUTURE", "Open new opportunities"],
              ].map(([title, text]) => (
                <div
                  key={title}
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
          <div>
            <div className="text-xs font-bold tracking-[.18em] text-[#17666a]">
              WHY IT CAN STILL FEEL DIFFICULT
            </div>

            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              The problem is not always that you are studying too little.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/55">
              Often, what is missing is not motivation but direction and real application.
            </p>
          </div>
