...
import GermanPathConversion from "@/components/en/GermanPathConversion";
import { germanCourses } from "@/lib/german-courses-en";
    ...
    <main className="min-h-screen bg-white text-[#17131c]">
      ...
      <section className="bg-[#D2ECFF]/55">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[690px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            <Link href="/en/kurse" className="text-sm font-semibold text-[#17666a]">← All German Courses</Link>
            <div className="mt-10 text-xs font-bold tracking-[.18em] text-[#17666a]">GERMAN A1–B2 · COMPLETE LEARNING PATH</div>
            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Four levels. One continuous path to B2.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Learn German not as four separate courses, but as one clear progression from the foundations to confident, more advanced communication.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              {["A1 → A2 → B1 → B2", "40 weeks total", "€979 individual value"].map((item) => (
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a href={whatsappLink(message)} target="_blank" rel="noreferrer" className="rounded-full bg-[#31175B] px-7 py-3.5 text-center text-sm font-semibold text-white">
                Ask about package options on WhatsApp
              </a>
              <a href="#lernweg" className="rounded-full border border-black/10 bg-white px-7 py-3.5 text-center text-sm font-semibold">Explore learning path</a>
            </div>
          </div>
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="home-orbit absolute right-10 -top-10 z-20 hidden rounded-2xl bg-[#58ECF1] px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.18)] lg:block">
              <div className="text-[10px] font-bold tracking-[.14em]">CLEAR PATH</div>
            ...
            <div className="home-orbit-delay absolute bottom-[-46px] left-10 z-20 hidden rounded-2xl bg-white px-5 py-4 shadow-[0_18px_50px_rgba(49,23,91,.16)] lg:block">
              <div className="text-[10px] font-bold tracking-[.14em] text-[#17666a]">PREVIOUS KNOWLEDGE?</div>
              <div className="mt-1 text-sm font-semibold">Start at the right level</div>
            </div>
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-5 shadow-[0_30px_90px_rgba(49,23,91,.16)] sm:p-7">
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  <div className="text-xs font-bold tracking-[.16em] text-[#31175B]">LIBELLE LEARNING PATH</div>
                  <div className="mt-2 text-3xl font-semibold">Deutsch A1–B2</div>
                </div>
                <span className="rounded-full bg-[#58ECF1] px-4 py-2 text-xs font-bold">4 levels</span>
              </div>
              ...
              <div className="mt-5 rounded-[1.6rem] bg-[#31175B] p-5 text-white">
                <div className="text-xs font-bold tracking-[.15em] text-[#58ECF1]">CURRENT INDIVIDUAL VALUE</div>
                <div className="mt-2 text-4xl font-semibold">979 €</div>
                <p className="mt-2 text-sm leading-6 text-white/65">Current package options are available via WhatsApp.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3 lg:hidden">
            <div className="home-orbit rounded-2xl bg-[#58ECF1] px-4 py-4 shadow-[0_12px_35px_rgba(49,23,91,.12)]">
              <div className="text-[9px] font-bold tracking-[.13em]">CLEAR PATH</div>
            ...
            <div className="home-orbit-delay rounded-2xl bg-white px-4 py-4 shadow-[0_12px_35px_rgba(49,23,91,.12)]">
              <div className="text-[9px] font-bold tracking-[.13em] text-[#17666a]">PREVIOUS KNOWLEDGE?</div>
      ...
      <EditorialStorySection
        eyebrow="THE PATH BEHIND THE LEVELS"
        title="Four levels. One bigger goal: communicate independently."
      ...
      <section id="lernweg" className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-3xl">
          <div className="text-xs font-bold tracking-[.18em] text-[#17666a]">YOUR PATH TO B2</div>
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">Every level prepares you for the next step.</h2>
      ...
      <section className="bg-[#31175B] text-white">
        <div className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
          <div className="max-w-3xl">
            <div className="text-xs font-bold tracking-[.18em] text-[#58ECF1]">WHY A COMPLETE LEARNING PATH?</div>
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">Progress becomes easier when the next step is already prepared.</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-[2.5rem] bg-[#D2ECFF]/55 p-8 sm:p-10">
            <div className="text-xs font-bold tracking-[.18em] text-[#17666a]">WHO IS IT FOR?</div>
          ...
          <div className="rounded-[2.5rem] bg-[#f7f5f9] p-8 sm:p-10">
            <div className="text-xs font-bold tracking-[.18em] text-[#31175B]">BEREITS PREVIOUS KNOWLEDGE?</div>
            <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">You do not automatically have to start at A1.</h2>
      ...
      <section className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-[2.8rem] bg-[#17131c] p-9 text-white sm:p-14">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <div className="text-xs font-bold tracking-[.18em] text-[#58ECF1]">YOUR NEXT STEP</div>
