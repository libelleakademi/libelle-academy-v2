...
const reasons = [
  {
    number: "01",
    title: "Do not book just any course",
...
const faqs = [
  ...
  [
    "Kann ich auch direkt Simulations buchen?",
  ...
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Find my personal learning path
              </a>
      ...
      <EditorialStorySection
        eyebrow="FROM MEDICAL KNOWLEDGE TO COMMUNICATION"
        title="Medical German connects professional knowledge with clear communication."
      ...
      <section className="bg-[#31175B] text-white">
        <div className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
              Your preparation should begin where you are today.
            </h2>
