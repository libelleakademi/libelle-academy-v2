...
export const metadata: Metadata = {
  title: "Resources | Libelle Academy",
  description:
...
const consultationMessage =
  "Hallo, ich suche Lernmaterialien oder Ressourcen bei Libelle Academy und möchte wissen, was zu meinem aktuellen Ziel passt. Quelle: RESOURCES-SEITE";
...
const digitalFeatures = [
  ...
  },
  {
    ...
    text: "Zusätzliche Inhalte ergänzen den Live lessons und helfen bei der Vertiefung.",
  },
  {
    number: "03",
  ...
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[650px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            ...
            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Keep learning German between lessons.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Digital learning materials, Prüfungstipps und ergänzende Inhalte
          ...
          <div className="relative mt-8 lg:mt-0">
            ...
            <div className="rounded-[2.8rem] bg-[#17131c] p-6 shadow-[0_30px_90px_rgba(49,23,91,.16)]">
              ...
              <div className="mt-3 text-3xl font-semibold">
                Live lessons ergänzen. Inhalte wiederholen. Weiterlernen.
              </div>
      ...
      <EditorialStorySection
        eyebrow="LEARNING BETWEEN SESSIONS"
        title="Fortschritt entsteht nicht nur während des Live lessonss."
        text="Digital materials, Wiederholung und selbstständige Vertiefung helfen dabei, Inhalte zwischen den Kursterminen verfügbar zu halten und gezielt weiterzuarbeiten."
      ...
      <section id="ressourcen" className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-4xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
            Resources aligned with your learning goal.
          </h2>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/60">
              ...
              Recordings, Materialien und weiteren Lerninhalten.
            </p>
          </div>
        ...
        <div className="grid items-center gap-8 rounded-[2.7rem] bg-[#f3eff7] p-9 sm:p-12 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <h2 className="mt-5 text-4xl font-semibold tracking-[-.035em]">
              German and exam tips on Instagram too.
            </h2>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-4xl">
          <div className="text-xs font-bold tracking-[.18em] text-[#17666a]">
            WO MÖCHTEN SIE KEEP LEARNING?
          </div>

          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
            Go directly to the right area.
          </h2>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2">
          ...
          >
            ...
            <h3 className="mt-5 text-3xl font-semibold">
              Explore German and medical courses.
            </h3>
