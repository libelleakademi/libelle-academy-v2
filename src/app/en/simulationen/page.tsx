...
import SimulationConversion from "@/components/en/SimulationConversion";
import { whatsappLink } from "@/lib/whatsapp";

export const metadata: Metadata = {
  title: "Exam Simulations | Libelle Academy",
  description:
    "Realistische Exam Simulationen mit individuellem Feedback für eine gezielte FSP- und FaMed-Vorbereitung.",
};

const mainMessage =
  "Hallo, ich interessiere mich für eine Exam Simulation bei Libelle Academy. Bitte senden Sie mir Informationen zu freien Terminen und den verfügbaren Optionen. Quelle: SIMULATIONEN-LANDING";

const consultationMessage =
  "Hallo, ich möchte wissen, welche Exam Simulation zu meiner aktuellen Vorbereitung passt. Quelle: SIMULATIONEN-BERATUNG";

const outcomes = [
  {
    number: "01",
    title: "Experience the exam realistically",
    text: "Trainieren Sie nicht nur einzelne Aufgaben, sondern eine zusammenhängende Prüfungssituation.",
  },
  {
    number: "02",
    title: "Identify uncertainties clearly",
    text: "Sie sehen, an welchen Stellen Kommunikation, Struktur oder sprachliche Sicherheit noch verbessert werden können.",
  },
  {
    number: "03",
    title: "Individual feedback erhalten",
    text: "Nach der Simulation erhalten Sie gezielte Rückmeldung zu Ihrer Leistung und zu den nächsten Trainingsschritten.",
  },
  {
    number: "04",
    title: "Continue training strategically",
...
const faqs = [
  [
    ...
    "Ja. Exam Simulationen können einzeln gebucht werden.",
  ],
  [
    "Gibt es auch mehrere Simulations als Paket?",
    "Ja. Neben einzelnen Simulations sind auch Paketoptionen verfügbar. Die aktuellen Möglichkeiten erfahren Sie über WhatsApp.",
  ],
  [
    "Was kostet eine Simulation?",
    "Die aktuell hinterlegten Simulations beginnen from €75.",
  ],
  [
    "Bekomme ich nach der Simulation Feedback?",
    "Ja. Individual feedback ist ein zentraler Bestandteil der Simulation.",
  ],
  [
  ...
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[720px] lg:grid-cols-[1.03fr_.97fr] lg:px-8">
          <div>
            ...
            <div className="mt-10 text-xs font-bold tracking-[.18em] text-[#17666a]">
              EXAM TRAINING · SIMULATIONS
            </div>

            <h1 className="mt-5 max-w-4xl text-5xl font-semibold leading-[1.02] tracking-[-.045em] sm:text-6xl lg:text-7xl">
              Simulate the exam before it really counts.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Realistic exam situations with individual feedback, so you discover your weak points before exam day.
            </p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Ask for an available simulation
              </a>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-4xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
            Do not guess whether you are ready. Test it.
          </h2>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-24 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
          <div>
            <div className="text-xs font-bold tracking-[.18em] text-[#58ECF1]">
              EXAM-FOCUSEDE VORBEREITUNG
            </div>

            <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
              Knowledge alone does not show how you communicate under pressure.
            </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              [
                "Wiederholbar",
                "Einzelne Simulations oder mehrere Trainings können je nach Bedarf kombiniert werden.",
              ],
            ].map(([title, text]) => (
              <div
                key={title}
      ...
      <EditorialStorySection
        eyebrow="FROM TEST TO NEXT STEP"
        title="A good simulation does not end with the final sentence."
        ...
        chip="SIMULATE → ANALYSIEREN → VERBESSERN"
        reverse
        dark
      />
      ...
      >
        <div className="max-w-4xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em] sm:text-5xl">
            Simulieren. Analysieren. Continue training strategically.
          </h2>
        </div>
