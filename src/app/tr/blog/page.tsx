...
import { blogPostsTR } from "@/lib/blog-posts-tr";

export const metadata: Metadata = {
  title: "Blog | Almanca, FSP & FaMed | Libelle Academy",
  description:
    "Almanca, medikal Almanca, FSP, FaMed ve Almanya'da çalışma hakkında içerikler.",
};

export default function BlogPage() {
  const featured = blogPostsTR[0];
  const rest = blogPostsTR.slice(1);
      ...
      <section className="bg-[#D2ECFF]/40">
        <div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-24">
          ...
          <h1 className="mt-5 max-w-4xl text-5xl font-semibold tracking-[-.045em] sm:text-6xl lg:text-7xl">
            Yolculuğunuzda gerçekten işinize yarayacak bilgiler.
          </h1>

          <p className="mt-7 max-w-2xl text-lg leading-8 text-black/55">
            Almanca, medikal dil, sınav hazırlığı ve Almanya'daki mesleki
            yolculuk hakkında net ve uygulanabilir içerikler.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-[-.035em]">
            Dil, medikal kariyer ve Almanya.
          </h2>
        </div>
