...
export const metadata: Metadata = {
  ...
  description: "A1'den B2'ye net ilerleme ve kişisel yönlendirme sunan yapılandırılmış Almanca öğrenme yolu.",
};

const levels = ["a1", "a2", "b1", "b2"] as const;
const message =
  "Merhaba, A1–B2 Almanca öğrenme yoluyla ilgileniyorum. Güncel paket koşulları ve doğru seviyeden başlama konusunda bilgi alabilir miyim? Kaynak: BUNDLE-DEUTSCH-A1-B2";

const benefits = [
  ["01", "Dört ayrı başlangıç yerine tek sistem", "Her seviye bir öncekinin üzerine kurulur. Kelime, gramer ve iletişim sistematik şekilde geliştirilir."],
  ["02", "B2'ye kadar net bir yol", "Başından itibaren sıradaki adımı bilirsiniz ve dil gelişiminizi uzun vadeli planlayabilirsiniz."],
  ["03", "Günlük yaşam, iş ve uzmanlaşma", "İlk günlük durumlardan B2 düzeyinde daha güvenli iletişime kadar ilerleyin."],
  ["04", "Doğru seviyeden başlangıç", "Ön bilginiz varsa A1'den başlamak zorunda değilsiniz. Doğru seviyeyi birlikte belirleyelim."],
];

const faqs = [
  ["A1'den başlamak zorunda mıyım?", "Hayır. Ön bilginiz varsa doğrudan seviyenize uygun bir kurstan başlayabilirsiniz."],
  ["Seviyeleri ayrı ayrı satın alabilir miyim?", "Evet. A1, A2, B1 ve B2 kursları ayrı ayrı da alınabilir."],
  ["A1–B2 öğrenme yolu toplam ne kadar sürüyor?", "Dört seviyenin toplam kurs süresi 40 haftadır."],
  ["Toplam fiyat nedir?", "A1, A2, B1 ve B2'nin güncel ayrı fiyatlarının toplamı 979 €'dur. Güncel paket koşullarını WhatsApp üzerinden öğrenebilirsiniz."],
];
  ...
  return (
    <main className="min-h-screen bg-white text-[#17131c]">
      ...
      <section className="bg-[#D2ECFF]/55">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[690px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">Almancayı dört ayrı kurs olarak değil, ilk temelden B2 seviyesinde daha güvenli iletişime uzanan tek bir gelişim yolu olarak ilerletin.</p>
      ...
      <EditorialStorySection
        ...
        text="A1, A2, B1 ve B2 birbirinden kopuk aşamalar değildir. Her seviye, günlük yaşamda ve iş hayatında daha bağımsız iletişim kurabilmeniz için bir sonrakini hazırlar."
        image="/images/a1-b2-life-in-germany.jpg"
        alt="Almanya’da günlük yaşam için Almanca öğrenme"
        chip="A1 → A2 → B1 → B2"
      />
      ...
      <section id="lernweg" className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-black/55">İlk cümlelerden daha gelişmiş iletişime kadar neyi geliştirdiğinizi ve sıradaki adımınızı her aşamada net şekilde görün.</p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-[2.5rem] bg-[#D2ECFF]/55 p-8 sm:p-10">
            ...
            <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">Almancayı uzun vadeli ve sistemli şekilde geliştirmek isteyenler için.</h2>
            <div className="mt-7 space-y-4 text-black/60">
              <p>✓ A1'den B2'ye net bir plan isteyenler</p>
              <p>✓ Almancayı günlük yaşam, iş veya eğitim için geliştirenler</p>
              <p>✓ Sürekli sistem değiştirmek yerine düzenli ilerlemek isteyenler</p>
              <p>✓ B2 sonrasında medikal Almancaya geçmek isteyenler</p>
            </div>
          </div>
          <div className="rounded-[2.5rem] bg-[#f7f5f9] p-8 sm:p-10">
            <div className="text-xs font-bold tracking-[.18em] text-[#31175B]">ÖN BİLGİNİZ VAR MI?</div>
            <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">Almancayı uzun vadeli ve sistemli şekilde geliştirmek isteyenler için.</h2>
            <p className="mt-5 text-lg leading-8 text-black/55">İlk cümlelerden daha gelişmiş iletişime kadar neyi geliştirdiğinizi ve sıradaki adımınızı her aşamada net şekilde görün.</p>
            <a href={whatsappLink("Merhaba, A1–B2 öğrenme yoluyla ilgileniyorum ve ön bilgim var. Doğru seviyeyi belirlememde yardımcı olabilir misiniz? Kaynak: BUNDLE-DEUTSCH-A1-B2-EINSTUFUNG")} target="_blank" rel="noreferrer" className="mt-8 inline-block rounded-full bg-[#31175B] px-7 py-3.5 text-sm font-semibold text-white">Seviyenizi birlikte belirleyelim</a>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-[2.8rem] bg-[#17131c] p-9 text-white sm:p-14">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <div className="text-xs font-bold tracking-[.18em] text-[#58ECF1]">BİR SONRAKİ ADIMINIZ</div>
              <h2 className="mt-4 max-w-3xl text-4xl font-semibold sm:text-5xl">B2'ye giden öğrenme yolunuzu planlayın.</h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-white/55">Mevcut seviyenizi ve hedefinizi bize yazın. Size uygun başlangıç noktasını ve güncel seçenekleri paylaşalım.</p>
            </div>
            <a href={whatsappLink(message)} target="_blank" rel="noreferrer" className="rounded-full bg-white px-7 py-4 text-center text-sm font-semibold text-[#31175B]">WhatsApp'tan bilgi al</a>
          </div>
        </div>
      </section>
    </main>
