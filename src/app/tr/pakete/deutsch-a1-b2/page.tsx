        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:min-h-[690px] lg:grid-cols-[1.05fr_.95fr] lg:px-8">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-black/60">
              Almancayı dört ayrı kurs olarak değil, ilk temellerden daha güvenli ve gelişmiş iletişime uzanan tek bir süreç olarak öğrenin.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-[2.5rem] bg-[#f7f5f9] p-8 sm:p-10">
            <div className="text-xs font-bold tracking-[.18em] text-[#31175B]">BEREITS ÖN BİLGİNİZ VAR MI?</div>
            <h2 className="mt-4 text-3xl font-semibold sm:text-4xl">A1'den başlamak zorunda değilsiniz.</h2>
