...
const situations = [
  {
    ...
    question: "Mein Deutsch fühlt sich für die FaMed noch nicht sicher genug an.",
    title: "Die FaMed beginnt nicht erst mit dem Prüfungsformat.",
    ...
    next: "Sprachstand ehrlich einschätzen → Lücken erkennen → gezielt auf die FaMed hinarbeiten",
  },
  {
    id: "application",
    number: "02",
...
const questions = [
  ...
  {
    q: "Ich habe bereits einen FaMed-Kurs gemacht. Macht ein weiterer Kurs überhaupt Sinn?",
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Nicht jeder FaMed-Kandidat braucht als Nächstes dasselbe.
            </h2>
