...
const situations = [
  {
    ...
    number: "01",
    label: "FACHSPRACHE",
    question: "Ich kenne Zahnmedizin – aber auf Deutsch fehlen mir oft die richtigen Formulierungen.",
    title: "Fachwissen und Fachsprache sind zwei verschiedene Dinge.",
  ...
  },
  {
    id: "communication",
    number: "02",
    label: "PATIENTENGESPRÄCH",
    question: "Im Patientengespräch verliere ich Struktur oder werde unsicher.",
    title: "Ein gutes Gespräch braucht mehr als richtige Fachbegriffe.",
  ...
  },
  {
    ...
    number: "03",
    label: "PRÜFUNGSNÄHE",
    question: "Meine FSP oder FaMed rückt näher und ich möchte wissen, ob ich bereit bin.",
    title: "Kurz vor der Prüfung wird Anwendung wichtiger als neues Material.",
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-4xl">
            <div className="text-xs font-bold tracking-[.18em] text-[#58ECF1]">
              WO LIEGT IHRE UNSICHERHEIT?
            </div>

            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Fachlich vorbereitet zu sein bedeutet noch nicht automatisch, sprachlich prüfungsbereit zu sein.
            </h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr]">
          <div className="lg:sticky lg:top-32 lg:self-start">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Die entscheidenden Fragen stehen nicht in der Kursbeschreibung.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/55">
              Wichtiger ist: Was können Sie bereits sicher – und was funktioniert unter Gesprächs- oder Prüfungsdruck noch nicht?
            </p>
          </div>
