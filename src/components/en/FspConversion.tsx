...
const situations = [
  {
    ...
    question: "My German does not yet feel strong enough for the FSP.",
    title: "Do not focus only on the exam too early.",
    ...
    next: "Assess your level → identify gaps → prepare strategically for the FSP",
  },
  {
    id: "application",
    number: "02",
...
const questions = [
  ...
  {
    q: "I have already taken an FSP course. Would another course still make sense?",
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Not every FSP candidate needs the same next step.
            </h2>
