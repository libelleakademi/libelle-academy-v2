...
const situations = [
  {
    ...
    question: "I know very little German and want to build a strong foundation from the beginning.",
    title: "A clear learning path is more important than simply having more material.",
  ...
  {
    id: "existing",
    label: "I ALREADY KNOW SOME GERMAN",
    question: "I have studied German before but do not know where I should start.",
    title: "You should not automatically start again at A1.",
  ...
  },
  {
    id: "stuck",
    label: "I FEEL STUCK",
    question: "I keep studying, but my German is not progressing consistently.",
    title: "The problem may be the lack of a clear learning path, not your motivation.",
...
const faq = [
  [
    "What if I studied German before and have forgotten a lot?",
  ...
  [
    "Do I have to decide on the complete path to B2 today?",
  ...
  [
    "I have started several courses before and stopped. What would be different this time?",
  ...
  [
    "How do I know whether I am truly ready for the next level?",
  ...
  [
    "What happens if I message Libelle on WhatsApp?",
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Not everyone needs A1. Everyone needs the right next step.
            </h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr]">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              The most important decision is not how quickly you start.
            </h2>
            <p className="mt-6 text-lg leading-8 text-black/55">
              What matters is starting at the right level and having a path you can realistically continue.
            </p>
          </div>
