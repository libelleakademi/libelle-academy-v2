...
const situations = [
  {
    ...
    question: "I know dentistry, but I often struggle to find the right wording in German.",
    title: "Professional knowledge and professional language are two different things.",
  ...
  },
  {
    ...
    question: "I lose structure or confidence during patient conversations.",
    title: "A good conversation requires more than correct terminology.",
  ...
  },
  {
    ...
    question: "My FSP or FaMed exam is getting closer and I want to know whether I am ready.",
    title: "Close to the exam, application becomes more important than new material.",
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              Being professionally prepared does not automatically mean being linguistically exam-ready.
            </h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[.72fr_1.28fr]">
          <div className="lg:sticky lg:top-32 lg:self-start">
            ...
            <h2 className="mt-4 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">
              The most important questions are not found in the course description.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/55">
              What matters is what already works confidently and what still breaks down under conversational or exam pressure.
            </p>
          </div>
